...
# 2 "book/duniverse/mdx.dev/lib/lexer.mll"
open Astring
...
# 267 "book/duniverse/mdx.dev/lib/lexer.ml"
  | 1 ->
let
...
# 284 "book/duniverse/mdx.dev/lib/lexer.ml"
  | 2 ->
let
...
# 309 "book/duniverse/mdx.dev/lib/lexer.ml"
  | 3 ->
let
...
# 320 "book/duniverse/mdx.dev/lib/lexer.ml"
...
# 334 "book/duniverse/mdx.dev/lib/lexer.ml"
  | 1 ->
let
...
# 344 "book/duniverse/mdx.dev/lib/lexer.ml"
  | __ocaml_lex_state -> lexbuf.Lexing.refill_buff lexbuf;
...
# 358 "book/duniverse/mdx.dev/lib/lexer.ml"
  | 1 ->
let
...
# 375 "book/duniverse/mdx.dev/lib/lexer.ml"
  | 2 ->
let
...
# 395 "book/duniverse/mdx.dev/lib/lexer.ml"
  | 3 ->
let
...
# 415 "book/duniverse/mdx.dev/lib/lexer.ml"
  | 4 ->
let
...
# 426 "book/duniverse/mdx.dev/lib/lexer.ml"
  | __ocaml_lex_state -> lexbuf.Lexing.refill_buff lexbuf;
...
# 438 "book/duniverse/mdx.dev/lib/lexer.ml"
  | 1 ->
...
# 443 "book/duniverse/mdx.dev/lib/lexer.ml"
  | 2 ->
let
...
# 454 "book/duniverse/mdx.dev/lib/lexer.ml"
  | __ocaml_lex_state -> lexbuf.Lexing.refill_buff lexbuf;
...
# 83 "book/duniverse/mdx.dev/lib/lexer.mll"
