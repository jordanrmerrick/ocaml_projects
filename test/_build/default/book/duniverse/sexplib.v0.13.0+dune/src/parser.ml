...
open Parsing;;
let _ = parse_error;;
# 2 "book/duniverse/sexplib.v0.13.0+dune/src/parser.mly"
...
# 23 "book/duniverse/sexplib.v0.13.0+dune/src/parser.ml"
let yytransl_const = [|
  258 (* LPAREN *);
  259 (* RPAREN *);
    0 (* EOF *);
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 32 "book/duniverse/sexplib.v0.13.0+dune/src/parser.mly"
                                    ( _2 )
# 170 "book/duniverse/sexplib.v0.13.0+dune/src/parser.ml"
               : Type.t))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'sexp_but_no_comment) in
    Obj.repr(
# 33 "book/duniverse/sexplib.v0.13.0+dune/src/parser.mly"
                      ( _1 )
# 177 "book/duniverse/sexplib.v0.13.0+dune/src/parser.ml"
               : Type.t))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 36 "book/duniverse/sexplib.v0.13.0+dune/src/parser.mly"
           ( Type.Atom _1 )
# 184 "book/duniverse/sexplib.v0.13.0+dune/src/parser.ml"
               : 'sexp_but_no_comment))
; (fun __caml_parser_env ->
    Obj.repr(
# 37 "book/duniverse/sexplib.v0.13.0+dune/src/parser.mly"
                  ( Type.List [] )
# 190 "book/duniverse/sexplib.v0.13.0+dune/src/parser.ml"
               : 'sexp_but_no_comment))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 1 : 'rev_sexps_aux) in
    Obj.repr(
# 38 "book/duniverse/sexplib.v0.13.0+dune/src/parser.mly"
                                ( Type.List (List.rev _2) )
# 197 "book/duniverse/sexplib.v0.13.0+dune/src/parser.ml"
               : 'sexp_but_no_comment))
; (fun __caml_parser_env ->
    Obj.repr(
# 39 "book/duniverse/sexplib.v0.13.0+dune/src/parser.mly"
          ( parse_failure "sexp" )
# 203 "book/duniverse/sexplib.v0.13.0+dune/src/parser.ml"
               : 'sexp_but_no_comment))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'sexp_but_no_comment) in
    Obj.repr(
# 42 "book/duniverse/sexplib.v0.13.0+dune/src/parser.mly"
                                  ( () )
# 210 "book/duniverse/sexplib.v0.13.0+dune/src/parser.ml"
               : 'sexp_comment))
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 43 "book/duniverse/sexplib.v0.13.0+dune/src/parser.mly"
                                                ( () )
# 218 "book/duniverse/sexplib.v0.13.0+dune/src/parser.ml"
               : 'sexp_comment))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'sexp_comment) in
    Obj.repr(
# 46 "book/duniverse/sexplib.v0.13.0+dune/src/parser.mly"
                 ( () )
# 225 "book/duniverse/sexplib.v0.13.0+dune/src/parser.ml"
               : 'sexp_comments))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'sexp_comments) in
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'sexp_comment) in
    Obj.repr(
# 47 "book/duniverse/sexplib.v0.13.0+dune/src/parser.mly"
                               ( () )
# 233 "book/duniverse/sexplib.v0.13.0+dune/src/parser.ml"
               : 'sexp_comments))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'sexp_but_no_comment) in
    Obj.repr(
# 50 "book/duniverse/sexplib.v0.13.0+dune/src/parser.mly"
                        ( Some _1 )
# 240 "book/duniverse/sexplib.v0.13.0+dune/src/parser.ml"
               : Type.t option))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'sexp_comments) in
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'sexp_but_no_comment) in
    Obj.repr(
# 51 "book/duniverse/sexplib.v0.13.0+dune/src/parser.mly"
                                      ( Some _2 )
# 248 "book/duniverse/sexplib.v0.13.0+dune/src/parser.ml"
               : Type.t option))
; (fun __caml_parser_env ->
    Obj.repr(
# 52 "book/duniverse/sexplib.v0.13.0+dune/src/parser.mly"
        ( None )
# 254 "book/duniverse/sexplib.v0.13.0+dune/src/parser.ml"
               : Type.t option))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'sexp_comments) in
    Obj.repr(
# 53 "book/duniverse/sexplib.v0.13.0+dune/src/parser.mly"
                      ( None )
# 261 "book/duniverse/sexplib.v0.13.0+dune/src/parser.ml"
               : Type.t option))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'sexp_but_no_comment) in
    Obj.repr(
# 56 "book/duniverse/sexplib.v0.13.0+dune/src/parser.mly"
                        ( [_1] )
# 268 "book/duniverse/sexplib.v0.13.0+dune/src/parser.ml"
               : 'rev_sexps_aux))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'sexp_comment) in
    Obj.repr(
# 57 "book/duniverse/sexplib.v0.13.0+dune/src/parser.mly"
                 ( [] )
# 275 "book/duniverse/sexplib.v0.13.0+dune/src/parser.ml"
               : 'rev_sexps_aux))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'rev_sexps_aux) in
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'sexp_but_no_comment) in
    Obj.repr(
# 58 "book/duniverse/sexplib.v0.13.0+dune/src/parser.mly"
                                      ( _2 :: _1 )
# 283 "book/duniverse/sexplib.v0.13.0+dune/src/parser.ml"
               : 'rev_sexps_aux))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'rev_sexps_aux) in
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'sexp_comment) in
    Obj.repr(
# 59 "book/duniverse/sexplib.v0.13.0+dune/src/parser.mly"
                               ( _1 )
# 291 "book/duniverse/sexplib.v0.13.0+dune/src/parser.ml"
               : 'rev_sexps_aux))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'rev_sexps_aux) in
    Obj.repr(
# 62 "book/duniverse/sexplib.v0.13.0+dune/src/parser.mly"
                      ( _1 )
# 298 "book/duniverse/sexplib.v0.13.0+dune/src/parser.ml"
               : Type.t list))
; (fun __caml_parser_env ->
    Obj.repr(
# 63 "book/duniverse/sexplib.v0.13.0+dune/src/parser.mly"
        ( [] )
# 304 "book/duniverse/sexplib.v0.13.0+dune/src/parser.ml"
               : Type.t list))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'rev_sexps_aux) in
    Obj.repr(
# 66 "book/duniverse/sexplib.v0.13.0+dune/src/parser.mly"
                      ( List.rev _1 )
# 311 "book/duniverse/sexplib.v0.13.0+dune/src/parser.ml"
               : Type.t list))
; (fun __caml_parser_env ->
    Obj.repr(
# 67 "book/duniverse/sexplib.v0.13.0+dune/src/parser.mly"
        ( [] )
# 317 "book/duniverse/sexplib.v0.13.0+dune/src/parser.ml"
               : Type.t list))
(* Entry sexp *)
