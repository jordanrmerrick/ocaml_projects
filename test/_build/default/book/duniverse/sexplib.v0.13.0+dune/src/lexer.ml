# 1 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
...
# 83 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"
...
and __ocaml_lex_main_rec buf lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 94 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
                     ( found_newline lexbuf 0;
                       main buf lexbuf )
# 369 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"

  | 1 ->
# 96 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
           ( main buf lexbuf )
# 374 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"

  | 2 ->
let
# 97 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
                          text
# 380 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
# 97 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
                               ( Token.comment text ~main buf lexbuf )
# 384 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"

  | 3 ->
# 98 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
        ( Token.lparen )
# 389 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"

  | 4 ->
# 99 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
        ( Token.rparen )
# 394 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"

  | 5 ->
# 101 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
      (
...
# 406 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"

  | 6 ->
# 109 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
         ( Token.hash_semi )
# 411 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"

  | 7 ->
# 111 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
      (
        let pos = Lexing.lexeme_start_p lexbuf in
        Quoted_string_buffer.add_lexeme buf lexbuf;
...
# 423 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"

  | 8 ->
# 119 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
         ( main_failure lexbuf "illegal end of comment" )
# 428 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"

  | 9 ->
# 125 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
      ( main_failure lexbuf "comment tokens in unquoted atom" )
# 433 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"

  | 10 ->
let
# 126 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
                                            str
# 439 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
# 126 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
                                                ( Token.simple_string str )
# 443 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"

  | 11 ->
# 127 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
        ( Token.eof )
# 448 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"
...
and __ocaml_lex_scan_string_rec buf start lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 130 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
        ( Quoted_string_buffer.add_lexeme buf lexbuf; () )
# 460 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"

  | 1 ->
# 132 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
      (
...
# 470 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"

  | 2 ->
# 139 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
      (
...
# 480 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"

  | 3 ->
let
# 145 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
                                                 c
# 486 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"
= Lexing.sub_lexeme_char lexbuf (lexbuf.Lexing.lex_start_pos + 1) in
# 146 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
      (
        Quoted_string_buffer.add_char buf (char_for_backslash c);
        Quoted_string_buffer.add_lexeme buf lexbuf;
        scan_string buf start lexbuf
      )
# 494 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"

  | 4 ->
let
# 151 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
                   c1
# 500 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"
= Lexing.sub_lexeme_char lexbuf (lexbuf.Lexing.lex_start_pos + 1)
and
# 151 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
                                 c2
# 505 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"
= Lexing.sub_lexeme_char lexbuf (lexbuf.Lexing.lex_start_pos + 2)
and
# 151 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
                                               c3
# 510 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"
= Lexing.sub_lexeme_char lexbuf (lexbuf.Lexing.lex_start_pos + 3) in
# 152 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
      (
...
# 528 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"

  | 5 ->
let
# 167 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
                          c1
# 534 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"
= Lexing.sub_lexeme_char lexbuf (lexbuf.Lexing.lex_start_pos + 2)
and
# 167 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
                                           c2
# 539 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"
= Lexing.sub_lexeme_char lexbuf (lexbuf.Lexing.lex_start_pos + 3) in
# 168 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
      (
...
# 548 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"

  | 6 ->
let
# 174 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
               c
# 554 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"
= Lexing.sub_lexeme_char lexbuf (lexbuf.Lexing.lex_start_pos + 1) in
# 175 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
      (
...
# 563 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"

  | 7 ->
# 182 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
      (
        found_newline lexbuf 0;
...
# 573 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"

  | 8 ->
# 189 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
      (
...
# 584 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"

  | 9 ->
# 197 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
      (
        let msg =
          sprintf
...
# 596 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"
...
and __ocaml_lex_scan_block_comment_rec buf locs lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 208 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
      ( Quoted_string_buffer.add_lexeme buf lexbuf;
        found_newline lexbuf 0; scan_block_comment buf locs lexbuf )
# 609 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"

  | 1 ->
# 211 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
      ( Quoted_string_buffer.add_lexeme buf lexbuf;
        scan_block_comment buf locs lexbuf )
# 615 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"

  | 2 ->
# 214 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
      (
        Quoted_string_buffer.add_lexeme buf lexbuf;
...
# 626 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"

  | 3 ->
# 222 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
    (
      Quoted_string_buffer.add_lexeme buf lexbuf;
      let cur = lexeme_end_p lexbuf in
...
# 636 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"

  | 4 ->
# 229 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
      (
        Quoted_string_buffer.add_lexeme buf lexbuf;
        match locs with
...
# 647 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"

  | 5 ->
# 237 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
      (
        match locs with
        | [] -> assert false
...
# 662 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"
...
# 249 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.mll"
...
# 744 "book/duniverse/sexplib.v0.13.0+dune/src/lexer.ml"
