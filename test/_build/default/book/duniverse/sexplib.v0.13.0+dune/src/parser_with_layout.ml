...
open Parsing;;
let _ = parse_error;;
# 2 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.mly"
...
# 62 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.ml"
let yytransl_const = [|
  259 (* LPAREN *);
  260 (* RPAREN *);
    0 (* EOF *);
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 75 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.mly"
           ( With_pos.atom _1 )
# 214 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.ml"
               : 'sexp_but_no_comment_abs))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 1 : 'rev_sexps_abs) in
    Obj.repr(
# 76 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.mly"
                                ( With_pos.list (List.rev _2) )
# 221 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.ml"
               : 'sexp_but_no_comment_abs))
; (fun __caml_parser_env ->
    Obj.repr(
# 77 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.mly"
          ( parse_failure "sexp" )
# 227 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.ml"
               : 'sexp_but_no_comment_abs))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : string * Lexing.position option) in
    Obj.repr(
# 80 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.mly"
            ( With_pos.plain_comment _1 )
# 234 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.ml"
               : 'comment_abs))
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 81 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.mly"
                                                       ( With_pos.sexp_comment (List.rev _2) _3 )
# 242 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.ml"
               : 'comment_abs))
; (fun __caml_parser_env ->
    Obj.repr(
# 84 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.mly"
                  ( [] )
# 248 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.ml"
               : 'rev_comments_abs))
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 85 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.mly"
                                 ( _2 :: _1 )
# 256 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.ml"
               : 'rev_comments_abs))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'sexp_but_no_comment_abs) in
    Obj.repr(
# 88 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.mly"
                            ( With_pos.sexp _1 )
# 263 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.ml"
               : 'sexp_abs))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'comment_abs) in
    Obj.repr(
# 89 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.mly"
                ( With_pos.comment _1 )
# 270 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.ml"
               : 'sexp_abs))
; (fun __caml_parser_env ->
    Obj.repr(
# 92 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.mly"
                ( [] )
# 276 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.ml"
               : 'rev_sexps_abs))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'rev_sexps_abs) in
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'sexp_abs) in
    Obj.repr(
# 93 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.mly"
                           ( _2 :: _1 )
# 284 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.ml"
               : 'rev_sexps_abs))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'sexp_abs) in
    Obj.repr(
# 96 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.mly"
             ( Type_with_layout.relativize _1 )
# 291 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.ml"
               : Type_with_layout.t_or_comment))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : Type_with_layout.t_or_comment) in
    Obj.repr(
# 99 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.mly"
         ( Some _1 )
# 298 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.ml"
               : Type_with_layout.t_or_comment option))
; (fun __caml_parser_env ->
    Obj.repr(
# 100 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.mly"
        ( None )
# 304 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.ml"
               : Type_with_layout.t_or_comment option))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : Type_with_layout.t_or_comment) in
    Obj.repr(
# 103 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.mly"
         ( [_1] )
# 311 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.ml"
               : 'rev_sexps_aux))
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 104 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.mly"
                       ( _2 :: _1 )
# 319 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.ml"
               : 'rev_sexps_aux))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'rev_sexps_aux) in
    Obj.repr(
# 107 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.mly"
                      ( _1 )
# 326 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.ml"
               : Type_with_layout.t_or_comment list))
; (fun __caml_parser_env ->
    Obj.repr(
# 108 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.mly"
        ( [] )
# 332 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.ml"
               : Type_with_layout.t_or_comment list))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'rev_sexps_aux) in
    Obj.repr(
# 111 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.mly"
                      ( List.rev _1 )
# 339 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.ml"
               : Type_with_layout.t_or_comment list))
; (fun __caml_parser_env ->
    Obj.repr(
# 112 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.mly"
        ( [] )
# 345 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.ml"
               : Type_with_layout.t_or_comment list))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'rev_sexps_abs) in
    Obj.repr(
# 116 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.mly"
                      ( List.rev _1 )
# 352 "book/duniverse/sexplib.v0.13.0+dune/src/parser_with_layout.ml"
