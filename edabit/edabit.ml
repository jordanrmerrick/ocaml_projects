...
(* Factorial function. O(1) complexity *)
...
*)
let persistence n =
  (* int_to_int_list splits an integer into digits and returns a list of those digits. Int -> String -> Char List -> String List -> Int List *)
